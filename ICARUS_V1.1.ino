...
unsigned char imu[9]={0x75,0x65,0x0C,0x03,0x03,0x01,0x10,0xFD,0xF4};
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 5;               //Gain setting for the roll P-controller 0.45
float pid_i_gain_roll = 0.001;              //Gain setting for the roll I-controller 
float pid_d_gain_roll = 0.001;                //Gain setting for the roll D-controller 
...
void loop(){
  ...
  if(start == 1 && receiver_input_channel_3 < 1100 && receiver_input_channel_4 > 1450){
    ...
    gyro_pitch = 0;                                          //Set the gyro pitch angle equal to the accelerometer pitch angle when the quadcopter is started.
    gyro_roll = 0;                                            //Set the gyro roll angle equal to the accelerometer roll angle when the quadcopter is started.
